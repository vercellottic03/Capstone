...
namespace The_Gaming_Library {
    ...
    public partial class Games : global::System.Data.DataSet {
        ...
        public partial class GamesDataTable : global::System.Data.TypedTableBase<GamesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public GamesRow AddGamesRow(string name, string genre, string console, string description, int count) {
...
namespace The_Gaming_Library.GamesTableAdapters {
    ...
    public partial class GamesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Games` WHERE ((`gameId` = @p1) AND (`name` = @p2) AND (`genre` = @p3" +
                ") AND (`console` = @p4) AND (`description` = @p5) AND (`count` = @p6))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Games` (`name`, `genre`, `console`, `description`, `count`) VALUES (" +
                "@p1, @p2, @p3, @p4, @p5)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Games` SET `name` = @p1, `genre` = @p2, `console` = @p3, `description` = " +
                "@p4, `count` = @p5 WHERE ((`gameId` = @p6) AND (`name` = @p7) AND (`genre` = @p8" +
                ") AND (`console` = @p9) AND (`description` = @p10) AND (`count` = @p11))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `gameId`, `name`, `genre`, `console`, `description`, `count` FROM `Games`";
